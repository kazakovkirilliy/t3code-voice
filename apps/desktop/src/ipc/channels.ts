...
export const KABAN_TRANSCRIBE_CHANNEL = "kaban:transcribe";
export const KABAN_SYNTHESIZE_CHANNEL = "kaban:synthesize";
export const KABAN_CANCEL_CHANNEL = "kaban:cancel";
